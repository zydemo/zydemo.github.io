...
![]({{ '/styles/article-image/20190302160812_2.jpg' | prepend: site.baseurl }})

安装成功之后再迁移数据库:

![]({{ '/styles/article-image/20190302160812_3.jpg' | prepend: site.baseurl }})

数据库迁移成功之后，程序会在blog下的**migrations目录**里自动生成几个000开头的文件，文件里面记录着数据库迁移记录：

![]({{ '/styles/article-image/20190302160812_4.jpg' | prepend: site.baseurl }})
